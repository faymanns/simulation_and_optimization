function [total_revenue, avg_available_seats_for_fare, avg_sold_out_time, avg_number_of_no_purchase, avg_number_of_sales_for_each_fare] = objective_function(scenario)
    ...
    parfor i = 1:nruns
        ...
        for k=1:1:scenario.NUMBER_OF_PRODUCTS
            number_of_sales_for_each_fare(i,k) = length(revenues(revenues==scenario.revenues(k)));
        end
    end
    ...
    avg_number_of_sales_for_each_fare = sum(number_of_sales_for_each_fare)/nruns; % how many times each fare was sold
end